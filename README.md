...
- يوجد **حساب مشرف واحد فقط** للمنظومة، وهو مخصّص لمالك الموقع فقط.
- بيانات الدخول (الإيميل وكلمة المرور) **غير منشورة هنا لأسباب أمنية**.
- **لا توجد أي طريقة أخرى للحصول على صلاحيات أدمن**: لا يوجد كود سري، ولا خانة "تسجيل كأدمن". كل حساب جديد يُنشأ كمستخدم عادي فقط.
...
1. اضغط على **"تسجيل الدخول"** وسجل بحساب الأدمن الخاص بالمالك.
